...
# workflow
1. ตัว Sensor ส่งสัญญาณไปยังวัตถุสะท้อนกลับมา<br>
2. ทำการคำนวนตามสูตรจะได้ระยะห่างระหว่างวัตถุเป็น cm<br>
3. ทำการแสดงผลทางหน้าจอ lcd<br>
4. motor ทำการหมุนเพื่อเปลี่ยนองศาการส่งสัญญาณ<br>
5. ถ้าต่อเข้ากับ PC หรือ laptop สามารถแสดงผลออกเป็น Radar ได้ ผ่านโปรแกรม processing (ซึ่งได้เรียนรู้อัลกอมาจากหลายๆแห่ง เนื่องจากไม่มีความรู้เรื่องโปรแกรมนี้)<br>
